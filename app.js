...
(function () {
  ...
  function seed() {
      ...
      const sample = [
        {
          ...
          type: "உழவரப்பணி",
          description: "மாதம் கடைசி ஞாயிறு காலை 9:00 – மதியம் 1:00. சுத்தம், தோட்டம், அன்னதானம் தயாரிப்பு."
        }
      ];
    ...
    if (!read(STORE.history, "").length) {
      write(
        STORE.history,
        "திரு தொண்டர்கள் நயினார் திருக்கோவில் – திருநெல்வேலி (Thiru Thondarkal Nainar Temple) திருநெல்வேலியில் அமைந்துள்ள புனித ஸ்தலம். பக்தர்களின் உழைப்பால் சுத்தம், அலங்காரம், திருப்பணி அனைத்தும் நடைபெறுகின்றன. " +
          "இங்கு ஆண்டுதோறும் சிறப்பு விழாக்கள், மாதந்தோறும் கடைசி ஞாயிற்றுக்கிழமை உழவரப்பணி நடைபெற்று பக்தர்கள் கலந்துகொள்கின்றனர். " +
